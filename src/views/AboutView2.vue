...
export default {
  ...
  methods: {
    getInfo(e) {
      this.title = e.target.id + " Kraj"
    },
    select(e) {
      this.selected[e.target.id] = !(this.colors[e.target.id] === this.color && this.selected[e.target.id])
      this.colors[e.target.id] = this.color;
    }
  },
}
</script>
